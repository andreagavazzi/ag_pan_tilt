...
# example from https://www.theconstructsim.com/morpheus-chair-dynamixel-servos-with-robot-arm-ros-s4-ep-1/

# obiettivo:
# rostopic pub /joint_trajectory trajectory_msgs/JointTrajectory "header:
#   seq: 0
#   stamp:
#     secs: 0
#     nsecs: 0
